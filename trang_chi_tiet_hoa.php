...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#f4fbeb">
    ...
    <td width="28%" valign="top"><table width="118%" border="0" cellpadding="0" cellspacing="2">
      ...
      <tr>
        <td><span class="style9"><img src="hinh_anh/IconMail.gif" width="16" height="16" /> <a href="./toanleviet95@gmail.com">toanleviet95@gmail.com </a></span></td>
      </tr>
      <tr>
  ...
  <tr bgcolor="#F4FBEB">
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0">
            ...
            <tr bgcolor="#F4FBEB">
              <td>&nbsp;<a href="trang_tim_kiem_hoa.php" class="style9">T&igrave;m ki&#7871;m b&oacute; hoa </a></td>
            </tr>
            <tr bgcolor="#F4FBEB">
              <td>&nbsp;<a href="trang_dang_ki.php" class="style9">Đăng kí tài khoản</a></td>
            </tr>
          </table>		  </td>
      </tr>
      <tr>
	...
	<?php include_once("PHP_source/ChiTietHoa.php") ?></td>
  </tr>
  <tr>
