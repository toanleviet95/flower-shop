  ...
  <tr bgcolor="#F4FBEB">
    ...
    <td width="28%" valign="top"><div align="center">
      <table width="300" border="0" cellpadding="0" cellspacing="2" bgcolor="#F4FBEB">
        ...
        <tr>
          <td><span class="style8"><img src="hinh_anh/IconMail.gif" width="16" height="16" /> <a href="./toanleviet95@gmail.com">toanleviet95@gmail.com </a></span></td>
          </tr>
        <tr>
  ...
  <tr bgcolor="#F4FBEB">
      ...
      <tr>
        <td bgcolor="#C7EAB0"><span class="style3">&nbsp;Danh mục
          ...
          <table width="100%" border="0" bgcolor="#F4FBEB">
            ...
            <tr>
              <td>&nbsp;<a href="trang_tim_kiem_hoa.php" class="style8">T&igrave;m ki&#7871;m b&oacute; hoa </a></td>
            </tr>
            <tr>
              <td height="21">&nbsp;<a href="trang_dang_ki.php" class="style8">Đăng kí tài khoản</a></td>
            </tr>
          </table>		  </td>
      </tr>
      <tr>
    ...
    <td colspan="3" valign="middle" bgcolor="#F4FBEB"><p>&nbsp;</p>
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
          <?php include_once("PHP_source/GiaoHang.php") ?>
          </td>
        </tr>
      </table>
      <p>&nbsp;</p>
