...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#f4fbeb">
    ...
    <td colspan="3" valign="top">	<form name="form1" method="post" action="trang_tim_kiem_hoa.php">
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#BBE09D">
        ...
        <tr>
          <td width="36%" bordercolor="#FFFFFF" bgcolor="#E8F6DC"><blockquote class="style10">
            T&ecirc;n b&oacute; hoa: 
          </blockquote></td>
          <td width="64%" bordercolor="#FFFFFF" bgcolor="#E8F6DC"><input name="ten" type="text" id="ten" size="30"><img src="hinh_anh/icon_search.gif"/></td>
        </tr>
        <tr>
  ...
  <tr bgcolor="#F4FBEB">
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0">
            ...
            <tr bgcolor="#F4FBEB">
              <td>&nbsp;<a href="trang_dang_ky.php" class="style10">Đăng kí tài khoản</a></td>
          </table>		  </td>
      </tr>
      <tr>
	...
	<?php include_once("PHP_source/TimKiem.php") ?></td>
  </tr>
  <tr>
    <td valign="top" bgcolor="#c7eab0"><span class="style2">Copyright &copy;2013-2014 <br />
