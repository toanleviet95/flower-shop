...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#F4FBEB">
      ...
      <tr>
        <td bgcolor="#C7EAB0"><span class="style3">&nbsp;Danh mục</span>
          <table width="100%" border="0" bgcolor="#F4FBEB">
            ...
            <tr>
              <td class="style10">&nbsp;<a href="trang_tim_kiem_hoa.php">T&igrave;m ki&#7871;m b&oacute; hoa </a></td>
            </tr>
            <tr>
              <td class="style10">&nbsp;<a href="trang_them_hoa.php">Th&ecirc;m m&#7899;i b&oacute; hoa </a></td>
            </tr>
          </table>		  </td>
      </tr>
      <tr>
    ...
    <td colspan="3" valign="top"><p>&nbsp;</p>
      <form action="trang_them_hoa.php" method="post" enctype="multipart/form-data" name="form1">
        <table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#E6F6D9">
          ...
          <tr>
            ...
            <td width="74%"><label>
              <input name="TenHoa" type="text" id="TenHoa" size="35">
            </label></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><label>
              <textarea name="MoTa" cols="35" id="MoTa"></textarea>
            </label></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><label>
              <input name="file_upload" type="file" size="45" id="file_upload">
            </label></td>
          </tr>
          <tr>
            <td height="35" colspan="2"><p align="center">
              <label>
              <input type="submit" name="ThemMoi" value="Thêm bó hoa mới" id="ThemMoi">
              </label>
            </p></td>
          </tr>
        </table>
...
<?php include_once("PHP_source/ThemMoiHoa.php") ?>	</td>
  </tr>
  <tr>
    <td valign="top" bgcolor="#DEF4CE"><span class="style2">Copyright &copy;2013-2014 <br />
